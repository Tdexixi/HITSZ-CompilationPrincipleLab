...
public class SymbolTable {
    ...
    private static final Map<String, SymbolTableEntry> cur_map = new HashMap<>();
    /**
     * 获取符号表中已有的条目
     *
     * @param text 符号的文本表示
    ...
    public SymbolTableEntry get(String text) {
        if (cur_map.containsKey(text)) {
            return cur_map.get(text);
        }
        else{
            return null;
        }
    ...
    public boolean has(String text) {
        return cur_map.containsKey(text);
    }
